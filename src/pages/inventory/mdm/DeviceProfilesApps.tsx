// ============================================================================
// §3.4 — device-reported identity & profiles, as collapsible sections.
//
...
//
// The APPS section used to live here too. It moved to sub-tab 5 (app control),
// where the whitelist presets and the two app-removal features are — apps are one
// subject and belong on one screen (IMPLEMENT 2026-08-13 remove_app_staff_ritual
// §0). See MdmDeviceAppsSection.
//
...
import {
  Lock, ShieldCheck, KeyRound, FileText,
...
import {
  fetchDeviceProfiles, fetchAssetCellular,
  queryProfiles, queryDeviceInfo,
  type MdmDeviceProfile, type MdmAssetCellular,
} from './mdmApi';
