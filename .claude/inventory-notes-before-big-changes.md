...
Verified via live API — no missing views or RPCs for inventory. Unlike pricing, the inventory backend is complete. See the verified column list in the memory file.
